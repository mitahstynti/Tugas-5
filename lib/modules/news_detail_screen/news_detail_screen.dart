            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  const Text(
                    'Buat yang dijalan harap hati hati. Buat yang dihati, kapan kita jalan jalan?',
                    maxLines: 10,
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(
              "https://i.postimg.cc/pXwZDJGr/syg.jpg",
            ),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24),
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  const Text(
                    'Libur Telah Tiba Horrayyy.. Libur telah tiba Horayy.. Hatiku Gembiraa',
                    maxLines: 10,
                    textAlign: TextAlign.justify,
                    overflow: TextOverflow.ellipsis,
                  )
